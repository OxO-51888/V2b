...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        'ticket_ai_tool_user_status_enable' => 'in:0,1',
        'ticket_ai_tool_order_enable' => 'in:0,1',
        'ticket_ai_tool_subscription_hit_enable' => 'in:0,1',
        'ticket_ai_tool_ops_context_enable' => 'in:0,1',
        'ticket_ai_tool_knowledge_enable' => 'in:0,1',
        'invite_force' => 'in:0,1',
